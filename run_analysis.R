...
# Load the test data
subject_test <- read.table("subject_test.txt", header=FALSE, sep="", colClasses="numeric", col.names="subject_id")
y_test <- read.table("y_test.txt", header=FALSE, sep="", colClasses="numeric", col.names="activity_id")
